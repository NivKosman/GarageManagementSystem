...
namespace Ex03.ConsoleUI
{
    public static class Messages
    {
          public static string
              ...
              GarageMenu = string.Format("Hello to our Garage:{0}1.Add New Car{0}2.See all license Number Vehicle in garage{0}3.Change status of car{0}4.fill air pressure in wheels of vehicle to Maximum{0}5.fill fuel vehicle{0}6.fill electric vehicle{0}7.show all details of vehicle", Environment.NewLine);
    }
}
